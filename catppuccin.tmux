...
main() {
  ...
  #readonly show_directory_in_window_status_current="#[fg=$thm_bg,bg=$thm_violet] #I #[fg=$thm_fg,bg=$thm_bg] #{b:pane_current_path} "
  readonly show_directory_in_window_status_current="#[fg=colour232,bg=$thm_violet] #I #[fg=colour255,bg=colour237] #(echo '#{pane_current_path}' | rev | cut -d'/' -f-2 | rev) "
  ...
  readonly show_window_in_window_status_current="#[fg=$thm_fg,bg=$thm_gray] #W #[fg=$thm_bg,bg=$thm_violet] #I#[fg=$thm_violet,bg=$thm_bg]$left_separator#[fg=$thm_fg,bg=$thm_bg,nobold,nounderscore,noitalics] "
 #setw -g window-status-current-format "#[fg=colour232,bg=$thm_violet] #I #[fg=colour255,bg=colour237] #(echo '#{pane_current_path}' | rev | cut -d'/' -f-2 | rev) "
